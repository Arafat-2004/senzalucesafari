...
import { ArrowRight, Phone, Calendar, CheckCircle2, Camera, Shield, Send, Grid, ListFilter, Images, Heart, Star, Quote, ChevronLeft, ChevronRight, X, ZoomIn, Video, Settings } from "lucide-react";
import { Button } from "@/components/ui/button";
import { vehicles, safariMoments, photographyTips, testimonials as testimonialsData } from "./data";
...
const useTranslations = () => {
    const translations: Record<string, string> = {
        // Comparison Table
        'vehicles.comparison.title': 'Vehicle Comparison',
        'vehicles.comparison.feature': 'Feature',
        'vehicles.comparison.capacity': 'Capacity',
        'vehicles.comparison.priceRange': 'Price Range',
        'vehicles.comparison.popUpRoof': 'Pop-Up Roof',
        'vehicles.comparison.refrigerator': 'Refrigerator',
        'vehicles.comparison.rating': 'Rating',
        'vehicles.comparison.reviews': 'reviews',
        'vehicles.comparison.bestFor': 'Best For',

        // Buttons
        'buttons.viewDetails': 'View Details',

        // Fleets Section
        'vehicles.fleets.downloadPDF': 'Download PDF Brochure',
        'vehicles.fleets.enginePerformance': 'Engine & Performance',
        'vehicles.fleets.safetyFeatures': 'Safety Features',
        'vehicles.fleets.safariEquipment': 'Safari Equipment',

        // Gallery Section
        'vehicles.gallery.allViews': 'All Views',
        'vehicles.gallery.exterior': 'Exterior',
        'vehicles.gallery.interior': 'Interior',
        'vehicles.gallery.actionShots': 'Action Shots',

        // Moments Section
        'vehicles.moments.quote': 'Every safari is a story waiting to be captured',
        'vehicles.moments.quoteSubtitle': 'Real moments from our guests in the wild',
        'vehicles.moments.photoTips': 'Photography Tips for Your Safari',
        'vehicles.moments.testimonials': 'What Our Guests Say',
        'vehicles.moments.shareMoments.title': 'Share Your Safari Moments',
        'vehicles.moments.shareMoments.description': 'Tag us on social media for a chance to be featured!'
    };
...
export default function VehiclesPage() {
    ...
    const tabs = useMemo(() => [
        { id: "all", label: "All Vehicles", icon: Grid, shortLabel: 'All' },
        { id: "fleets", label: "Our Fleet", icon: ListFilter, shortLabel: 'Fleet' },
        { id: "gallery", label: "Photo Gallery", icon: Images, shortLabel: 'Gallery' },
        { id: "moments", label: "Safari Moments", icon: Heart, shortLabel: 'Moments' },
        { id: "configurator", label: "Safari Configurator", icon: Settings, shortLabel: 'Config' },
        { id: "videos", label: "Video Gallery", icon: Video, shortLabel: 'Videos' },
        { id: "instagram", label: "Instagram Feed", icon: Heart, shortLabel: 'Insta' },
        { id: "booking", label: "Book Now", icon: Calendar, shortLabel: 'Book' }
    ], []);
    ...
    }, [activeTab, selectedVehicle, galleryFilter, currentTestimonial, trackEvent]);
            ...
            <section className="py-16 md:py-20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10">
                <div className="container px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                        Ready to Experience Our Safari Vehicles?
                    </h2>
                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Get personalized recommendations and book your dream safari adventure today
                    </p>
