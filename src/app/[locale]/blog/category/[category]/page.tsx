...
import { Calendar, User, ArrowRight, Clock, ChevronRight, ArrowLeft } from "lucide-react";
    ...
    return (
        <div className="min-h-screen">
            ...
            <HeroSection
                ...
                ctaText={t('blogCategory.browseArticles')}
                ctaLink="#articles"
            />
                    ...
                    <>
                        <div className="mb-12">
                            ...
                            <p className="text-muted-foreground max-w-2xl">
                                {filteredPosts.length} {filteredPosts.length === 1 ? t('blogCategory.article') : t('blogCategory.articles')} {t('blogCategory.found')}
                            </p>
                        </div>
