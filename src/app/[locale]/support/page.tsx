                ...
                <div className="container px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        ...
                        >
                            ...
                            <h3 className="font-bold text-foreground mb-2">{t('support.contact.email.title')}</h3>
                            <p className="text-sm text-muted-foreground mb-3">{t('support.contact.email.description')}</p>
                        ...
                        >
                            ...
                            <h3 className="font-bold text-foreground mb-2">{t('support.contact.phone.title')}</h3>
                            <p className="text-sm text-muted-foreground mb-3">{t('support.contact.phone.description')}</p>
                            <span className="text-primary font-semibold text-sm flex items-center gap-2 group-hover:gap-3 transition-all">
                                +255 123 456 789
                                <ArrowRight className="w-4 h-4" />
                            </span>
                        ...
                        >
                            ...
                            <h3 className="font-bold text-foreground mb-2">{t('support.contact.message.title')}</h3>
                            <p className="text-sm text-muted-foreground mb-3">{t('support.contact.message.description')}</p>
                            <span className="text-primary font-semibold text-sm flex items-center gap-2 group-hover:gap-3 transition-all">
                                {t('support.contact.message.link')}
                                <ArrowRight className="w-4 h-4" />
                            </span>
                        </Link>
                    </div>
