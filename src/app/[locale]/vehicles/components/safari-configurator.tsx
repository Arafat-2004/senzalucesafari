        ...
        switch (step) {
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.groupSize')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.whatIsYourGroupSize')}</p>
                        </div>
            ...
            case 2:
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.budget')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.whatIsYourBudget')}</p>
                        </div>
            ...
            case 3:
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.safariType')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.whatSafariType')}</p>
                        </div>
            ...
            case 4:
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.duration')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.howLong')}</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            case 5:
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.specialReqs')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.anySpecialRequirements')}</p>
                        </div>
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t('vehicles.configurator.recommendation.yourPerfectSafari')}</h3>
                            <p className="text-muted-foreground">{t('vehicles.configurator.recommendation.basedOnPreferences')}</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl p-6 md:p-8 border-2 border-primary/30">
                            ...
                            <div className="bg-white dark:bg-card rounded-xl p-6 mb-6">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">{t('vehicles.configurator.recommendation.perfectFor')} {config.groupSize} {t('vehicles.configurator.recommendation.person')} {config.safariType} {t('vehicles.configurator.recommendation.safari')}</p>
                            ...
                            <div className="bg-white dark:bg-card rounded-xl p-6">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">{t('vehicles.configurator.recommendation.tailoredTo')} {config.duration} {t('vehicles.configurator.recommendation.dayPreference')}</p>
                                <Button variant="outline" className="w-full" nativeButton={false} render={<I18nLink href="/safaris-tours" className="inline-flex items-center justify-center" />} onClick={() => {
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {step < 7 && (
                <div className="flex justify-between mt-8 pt-6 border-t border-border/50">
                    ...
                    >
                        {step === 5 ? t('vehicles.configurator.continue') : step === 6 ? 'See My Match' : t('vehicles.configurator.continue')}
