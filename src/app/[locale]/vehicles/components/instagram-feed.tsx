        ...
        <div className="space-y-8">
            ...
            <div className="text-center max-w-2xl mx-auto">
                <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                    {t('vehicles.instagram.followAdventures')}
                </h3>
                <p className="text-muted-foreground mb-6">
                    {t('vehicles.instagram.shareMoments')}
                </p>
                <a
            ...
            <div className="bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-orange-500/10 rounded-2xl p-6 border border-purple-500/20">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h4 className="font-bold text-foreground mb-2">{t('vehicles.instagram.liveFeed')}</h4>
                        <p className="text-sm text-muted-foreground mb-3">
                            {t('vehicles.instagram.liveFeedDescription')}
                        </p>
