                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                    ...
                    <tr>
                      <td style="padding: 12px 0; border-bottom: 1px solid #e5e5e5;">
                        ...
                        <a href="mailto:${inquiry.email}" style="color: #0c2317; font-size: 16px; text-decoration: none;">${inquiry.email}</a>
                      </td>
                    </tr>
                    ${inquiry.phone ? `
                    <tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" style="padding: 24px 0;">
                        <a href="${siteUrl}/admin/inquiries" style="display: inline-block; background-color: #0c2317; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-size: 16px; font-weight: 600;">View in Admin Dashboard</a>
                      </td>
                    </tr>
                  </table>
                </td>
