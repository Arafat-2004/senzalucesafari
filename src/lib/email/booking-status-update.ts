            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              ...
              <tr>
                <td style="padding: 40px;">
                    ...
                    <tr>
                      <td>
                        <p style="margin: 0; color: #333333; font-size: 14px;">
                          ...
                          <span style="font-size: 24px; font-weight: bold; color: #0c2317; font-family: monospace;">${data.bookingRef}</span>
                        </p>
                      </td>
                    </tr>
                  </table>
                      ...
                      <td>
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td style="padding: 8px 0; font-size: 14px; text-align: right; font-weight: 500; color: #0c2317;">
                  ...
                  <!-- Completed Message -->
                  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fdfcfa; border-left: 4px solid #b5893e; border-radius: 4px; padding: 20px; margin-bottom: 24px;">
                    <tr>
                      <td>
                        <p style="margin: 0; color: #333333; font-size: 15px; line-height: 1.6;">
                  ...
                  <p style="margin: 0; color: #333333; font-size: 16px; line-height: 1.6;">
                    Warm regards,<br>
                    <strong style="color: #0c2317;">Senza Luce Safaris Team</strong>
                  </p>
                </td>
              </tr>
