...
export type CMSEntityType = 'vehicle' | 'tour' | 'booking' | 'blog' | 'review' | 'user' | 'inquiry' | 'notification' | 'settings' | 'destination' | 'accommodation' | 'faq' | 'guide' | 'newsletter' | 'team_member';
